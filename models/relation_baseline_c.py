...
class Baseline(BaseModel):
    ...
    def build_model(self):
        ...
        sentence = Bidirectional(GRU(300,
                                     ...
                                     dropout=0.3))(self.sen_embedding)
    ...
    def compile_model(self):
        inputs = [self.sen_input, self.trigger_type_input, self.entity_type_input] = self.make_input()
    ...
    def make_input(self):
        ...
        inputs[1] = Input(shape=(1,), dtype='int32', name='trigger_type')
        inputs[2] = Input(shape=(1,), dtype='int32', name='entity_type')
    ...
    def embedded(self):
        ...
        return [sentence_embedding, trigger_type_embedding, entity_type_embedding]
