...
class RF(BaseModel):
    ...
    def build_model(self):
        ...
        triggers = Lambda(liter,
                          ...
                          arguments={'length': self.max_len})(trigger)  # (?, 82, 300)
        x = Concatenate()([triggers, sentence])  # (?, 82, 900)
        ...
        x = Lambda(attention, output_shape=attention_output_shape, arguments={'dim': 600})([attention_x, sentence])  # (?, 600)
        ...
        x = Concatenate()([trigger_type, entity_type, trigger, entity, x])
