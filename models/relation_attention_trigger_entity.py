...
from models.realation_fusion import attention_output_shape, attention
from models.relation_attention import reduce_dimension
...
from models.relation_interaction import reduce_dimension_output_shape
...
class RM(BaseModel):
    ...
    def __init__(self, max_len=125, class_num=9, use_development_set=True):
        ...
        self.name = "attention_trigger_entity"
    ...
    def build_model(self):
        ...
        weighted_sentence = Lambda(attention, output_shape=attention_output_shape, arguments={'dim': 600})([x, sentence])  # (?, 600)

        x = Concatenate()([trigger, entity, weighted_sentence])  # (?, 1300)
