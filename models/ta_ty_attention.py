...
class RF(BaseModel):
    ...
    def __init__(self, max_len=125, class_num=9, use_development_set=True):
        ...
        super(RF, self).__init__(use_development_set)
    ...
    def build_model(self):
        ...
        x3 = Lambda(attention, output_shape=attention_output_shape, arguments={'dim': 600})([x3, sentence])  # (?, 600)
        # -----------------------------------------------------------
...
if __name__ == '__main__':
    ...
    s = RF(max_len=125, class_num=9, use_development_set=False)
    for i in range(5):
        s.compile_model()
